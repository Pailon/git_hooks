...
Данный учебный проект был на целен на практику работы 
с внешними API(в частности с API GitHub). А так же практика
работы с технологиями React Hooks, Bootstrap 4, SASS

## Возможности
- Поиск пользователей GitHub по нику
- Отображение информации о пользователе на отдельной странице
